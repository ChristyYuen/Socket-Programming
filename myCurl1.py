...
def clienting(clientSocket):
        ...
        HTTPRequestDecodedString = "" 
        for i in range (0 ,len(HTTPRequestDecoded)): #making the entire file name after splitting in args
                HTTPRequestDecodedString += HTTPRequestDecoded[i]
        ...
        sourceIP = ''
        destPort = '' 
        ServerResponseLine = HTTPRequestDecodedString
